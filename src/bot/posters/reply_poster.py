...
class ReplyPoster:
    ...
    def _is_image_request(self, text: str) -> bool:
        # Use the prompt extraction logic to detect if an image was requested
        return extract_prompt(text) != text


    def _handle_image_reply(self, reply):
    ...
    def _handle_text_reply(self, reply):
